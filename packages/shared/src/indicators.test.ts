...
describe('TechnicalIndicators', () => {
  ...
  describe('SMA', () => {
    it('should calculate simple moving average correctly', () => {
      ...
      const sma = TechnicalIndicators.sma(values, 3);
  ...
  describe('EMA', () => {
    it('should calculate exponential moving average', () => {
      const values = [1, 2, 3, 4, 5];
      const ema = TechnicalIndicators.ema(values, 3);
  ...
  describe('RSI', () => {
    it('should calculate RSI values', () => {
      ...
      const rsi = TechnicalIndicators.rsi(closes, 3);
  ...
  describe('ATR', () => {
    it('should calculate Average True Range', () => {
      const atr = TechnicalIndicators.atr(mockKlines, 3);
  ...
  describe('Donchian Channels', () => {
    it('should calculate Donchian channels', () => {
      const donchian = TechnicalIndicators.donchian(mockKlines, 3);
  ...
  describe('Standard Deviation', () => {
    it('should calculate standard deviation', () => {
      const values = [1, 2, 3, 4, 5];
      const stdDev = TechnicalIndicators.stdDev(values, 3);
  ...
  describe('Z-Score', () => {
    it('should calculate z-score correctly', () => {
      const zScore = TechnicalIndicators.zScore(5, 3, 1);
      expect(zScore).toBe(2);
      
      const zScoreZero = TechnicalIndicators.zScore(5, 3, 0);
  ...
  describe('Normalize', () => {
    it('should normalize values to 0-1 range', () => {
      expect(TechnicalIndicators.normalize(0)).toBe(0.5);
      expect(TechnicalIndicators.normalize(1)).toBeGreaterThan(0.5);
      expect(TechnicalIndicators.normalize(-1)).toBeLessThan(0.5);
      
      // Should clamp to 0-1 range
      const normalized = TechnicalIndicators.normalize(100);
  ...
  describe('Realized Volatility', () => {
    it('should calculate realized volatility', () => {
      const closes = mockKlines.map(k => k.close);
      const volatility = TechnicalIndicators.realizedVolatility(closes, 3);
