...
const handler = async (event, context) => {
    ...
    try {
        ...
        const klinesData = await mexcClient.fetchMultipleKlines(symbolNames, timeframe, 200);
        ...
        const results = await dataProcessor.processSymbols(klinesData, symbolsInfo, timeframe);
